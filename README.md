...
Cadrage terminé le 7 septembre 2026. Lots 0 à 4 livrés : socle, contrat de données, adaptateur KKBox, jeu d'apprentissage sans fuite et protocole d'évaluation. Lots 5 à 7 livrés : modèle et explicabilité, export des listes, interface Streamlit. Sur KKBox, le modèle atteint une Precision@50 de 0,323, contre 0,149 pour la meilleure régression logistique et 0,098 pour le tri par revenu, détail dans `docs/resultats.md`. Lot 8, présentation du projet, en cours.
